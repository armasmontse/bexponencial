...
abstract class CltvoNotification extends Notification
{
    ...
    protected $email_new_subscriber = 'vendor.notifications.email-subscription-success';
	...
	public static function GroupNotify(array $users,array $args)
	{
		if (!empty($users)) {
			\Notification::send(collect($users),  new static( $args ) );
		}
	}
