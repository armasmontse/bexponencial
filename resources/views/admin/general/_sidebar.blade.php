<div class="sidebar" id="admin-main-menu">
	<div class="sidebar__main">
		...
		<a class="sidebar__main--logo" href="" alt="{{ config( "app.name") }}" style="background-image:url({{ asset('images/logo.svg') }});">
		</a>
		...
		<div class="sidebar__main--profile">
			...
			<ul id='dropdown1' class='dropdown-content sidebar__main--profile--dropDown-ul'>
				<li><a href="" class="sidebar__main--profile--dropDown-ul--link">{!! trans('admin.layout.sidebar.my_account') !!}</a></li>
				<li><a href="" class="sidebar__main--profile--dropDown-ul--link">{!! trans('admin.layout.sidebar.see_site') !!}</a></li>
				<li class="divider"></li>
